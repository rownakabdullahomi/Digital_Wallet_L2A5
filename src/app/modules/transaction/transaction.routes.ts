...
router.post("/user-cash-in-out", checkAuth(Role.USER), TransactionController.cashInOutRequestFromUser);
router.post("/cash-in-out-approval-from-agent", checkAuth(Role.AGENT), TransactionController.cashInOutApprovalFromAgent);
