...
const createNewAccessTokenWithRefreshToken = (refreshToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if ((isUserExist === null || isUserExist === void 0 ? void 0 : isUserExist.isActive) === user_interface_1.IsActive.BLOCKED ||
        (isUserExist === null || isUserExist === void 0 ? void 0 : isUserExist.isActive) === user_interface_1.IsActive.INACTIVE) {
