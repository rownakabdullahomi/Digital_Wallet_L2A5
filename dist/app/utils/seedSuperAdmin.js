...
const seedSuperAdmin = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const hashedPassword = yield bcryptjs_1.default.hash(env_1.default.SUPER_ADMIN_PASSWORD, Number(env_1.default.BCRYPT_SALT_ROUND));
        const authProvider = {
        ...
        const payload = {
            ...
            isDeleted: false,
            auths: [authProvider],
            isAgentApproved: user_interface_1.IsAgentApproved.APPROVED,
        };
